---
name: encounter-sim
description: Use when running, narrating, or analysing 5E-compatible combat — resolving attacks, spells, movement, conditions, items, death saves, linked chapters, expected damage, win rate, or campaign content. Drives the bundled `fivee` command; not for rules lookup outside combat or character creation. The play-mechanics fallback is not an encounter-sim trigger.
---
