...
Modules here hold the logic the MCP tools and the REST server both expose. The
rule that makes two thin adapters possible is that nothing in this package may
import MCP, HTTP, or any transport's error type: functions take plain values,
